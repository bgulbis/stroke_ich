SELECT DISTINCT
	...
	(CLINICAL_EVENT.EVENT_END_DT_TM - ENCOUNTER.REG_DT_TM) * 24 AS ADMIT_EVENT_HR,
	(CLINICAL_EVENT.EVENT_END_DT_TM - ENCOUNTER.ARRIVE_DT_TM) * 24 AS ARRIVE_EVENT_HR,
...
WHERE
    ...
    AND (
        ...
        AND CLINICAL_EVENT.EVENT_CD IN (30098, 134401648)
