...
SELECT
	...
	ORDER_ROUTE.ENCNTR_ID,
	ORDER_ROUTE.MED_DATETIME,
	ORDER_ROUTE.EVENT_ID,
	ORDER_ROUTE.ADMIN_EVENT,
	ORDER_ROUTE.NURSE_UNIT,
	ORDER_ROUTE.MED_SERVICE
FROM
	ENCNTR_ALIAS,
	ORDER_ROUTE
WHERE
	ORDER_ROUTE.ENCNTR_ID = ENCNTR_ALIAS.ENCNTR_ID
	AND ENCNTR_ALIAS.ENCNTR_ALIAS_TYPE_CD = 619 -- FIN NBR
	AND ENCNTR_ALIAS.ACTIVE_IND = 1
	AND ORDER_ROUTE.ADMIN_EVENT IN ('Not Done', 'Not Given')
	AND ORDER_ROUTE.RXROUTE = 'SUB-Q'