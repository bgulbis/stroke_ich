SELECT
    ...
    pi_from_gmt(ENCNTR_LOC_HIST.BEG_EFFECTIVE_DT_TM, (pi_time_zone(1, @Variable('BOUSER')))) AS START_DATETIME,
    pi_from_gmt(ENCNTR_LOC_HIST.END_EFFECTIVE_DT_TM, (pi_time_zone(1, @Variable('BOUSER')))) AS STOP_DATETIME
FROM
    ...
    NOMENCLATURE
WHERE
    NOMENCLATURE.SOURCE_IDENTIFIER IN ('I61.0','I61.1','I61.2','I61.3','I61.4','I61.5','I61.6','I61.8','I61.9')
    ...
    AND (
        ...
        AND ENCNTR_LOC_HIST.LOC_NURSE_UNIT_CD <> 9996629
        AND ENCNTR_LOC_HIST.TRANSACTION_DT_TM = (
            ...
            WHERE 
                ...
                AND ELH.LOC_NURSE_UNIT_CD <> 9996629
        )
