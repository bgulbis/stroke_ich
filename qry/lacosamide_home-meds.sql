SELECT DISTINCT
	...
	CASE ORDERS.ORIG_ORD_AS_FLAG 
        WHEN 1 THEN 'Prescription/Discharge Order'
        WHEN 2 THEN 'Recorded / Home Meds'
        WHEN 3 THEN 'Patient Owns Meds'
        WHEN 4 THEN 'Pharmacy Charge Only'
        WHEN 5 THEN 'Satellite (Super Bill) Meds'
        ELSE 'Normal Order'
    END AS ORDER_TYPE
FROM
	ENCOUNTER,
